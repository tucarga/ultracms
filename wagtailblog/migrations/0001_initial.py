...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'wagtailblog_blogindexpage', (
        ...
        db.send_create_signal(u'wagtailblog', ['BlogIndexPage'])

        # Adding model 'BlogPageTag'
        db.create_table(u'wagtailblog_blogpagetag', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'wagtailblog_blogpagetag_items', to=orm['taggit.Tag'])),
            ('content_object', self.gf('modelcluster.fields.ParentalKey')(related_name='tagged_items', to=orm['wagtailblog.BlogPage'])),
        ))
        db.send_create_signal(u'wagtailblog', ['BlogPageTag'])

        # Adding model 'BlogPage'
        db.create_table(u'wagtailblog_blogpage', (
            (u'page_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['wagtailcore.Page'], unique=True, primary_key=True)),
        ...
        db.send_create_signal(u'wagtailblog', ['BlogPage'])


    def backwards(self, orm):
        # Deleting model 'BlogIndexPage'
        db.delete_table(u'wagtailblog_blogindexpage')

        # Deleting model 'BlogPageTag'
        db.delete_table(u'wagtailblog_blogpagetag')

        # Deleting model 'BlogPage'
        db.delete_table(u'wagtailblog_blogpage')
    ...
    models = {
        ...
        u'wagtailblog.blogpage': {
            'Meta': {'ordering': "['sort_order']", 'object_name': 'BlogPage', '_ormbases': [u'wagtailcore.Page']},
        ...
        u'wagtailblog.blogpagetag': {
            'Meta': {'object_name': 'BlogPageTag'},
            'content_object': ('modelcluster.fields.ParentalKey', [], {'related_name': "'tagged_items'", 'to': u"orm['wagtailblog.BlogPage']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'tag': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'wagtailblog_blogpagetag_items'", 'to': u"orm['taggit.Tag']"})
        },
        u'wagtailcore.page': {
